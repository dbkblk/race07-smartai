Ring_Knutstorp
{
  ...
  TrackName = Ring Knutstorp Motorbana
  TrackNameShort = Knutstorp
  GrandPrixName = Ring Knutstorp, 2008
  EventName = Round 1&9: Knutstorp
  VenueName = Knutstorp STCC 2008
  Location = Knutstorp, Sweden
  Length = 1.286 mi/2.070 km
  Track Record = Fredrik Ekblom 1:00.571
  EventDate=20 April, Sweden
  TrackInfo=
  Category=STCC

  SettingsFolder = Ring_Knutstorp
