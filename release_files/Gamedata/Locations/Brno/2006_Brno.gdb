2006_Brno
{
  ...
  TrackName = Brno, 2006 FIA WTTC Round 7
  TrackNameShort = Brno 06
  GrandPrixName = Brno, 2006
  EventName = Round 7: BRNO
  VenueName = Race of Czech Republic
  Location = Brno, Czech Republic
  Length = 3.357 mi / 5.403 km
  Track Record = gabriele tarquini 02:12.286
  EventDate = 1-3 September, Czech Republic
  TrackInfo=BRNO INFO
  Category=2006
