Nurburgring
{
 ...
 RollingStartDistFromSFLine=100
  ...
  TrackNameShort = Nurburgring GP
  GrandPrixName = Nurburgring 2008
  EventName = Nurburgring Grand Prix
  VenueName = TODO fix venue name
  Location = Nurburg, Germany
  Length = 3.198 mi / 5.147 km
  Track Record = Gil Ritter 1:29.468
  EventDate = 
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Nurburgring_GP
  SettingsCopy = Nurburgring_GP.svm
  SettingsAI = Nurburgring_GP.svm
