2006_Oschersleben_rev
{
  ...
  TrackName = Oschersleben Reverse
  TrackNameShort = Oschersleben Reverse 06
  GrandPrixName = Oschersleben Reverse
  EventName = Oschersleben Reverse
  VenueName = Race of Germany
  Location = Oschersleben, Germany
  Length = 2.279 mi / 3.667 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Oschersleben_rev
  SettingsCopy = Oschersleben_rev.svm
  SettingsAI = Oschersleben_rev.svm
