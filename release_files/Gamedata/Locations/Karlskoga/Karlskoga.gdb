Karlskoga
{
  ...
  TrackName = Karlskoga Motorstadion
  TrackNameShort = Karlskoga
  GrandPrixName = Karlskoga, 2008
  EventName = Round 5&8: Karlskoga
  VenueName = Karlskoga STCC 2008
  Location = Karlskoga, Sweden
  Length = 1.572 mi/2.530 km
  Track Record = Richard Goransson 1:07.112
  EventDate=17 August, Sweden
  TrackInfo=
  Category=STCC

  SettingsFolder = Karlskoga
