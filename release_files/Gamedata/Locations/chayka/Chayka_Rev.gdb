Chayka_Rev
{
  ...
  TrackName = Chayka Reverse
  TrackNameShort = Chayka Reverse
  GrandPrixName = Chayka Reverse
  EventName = Chayka Reverse
  EventDate= June
  VenueName = This is Jakob content
  Location = Kiev, Ukraine
  Length = 2.598 mi / 4.182 km
//  Track Record=
  EventDate=Jakob content
  TrackInfo=CHAYKA SPORTS COMPLEX
  Category=VARIATIONS

  SettingsFolder = Chayka
  SettingsCopy = Chayka_Rev.svm
  SettingsAI = Chayka.svm
  Qualify Laptime = 120.000
