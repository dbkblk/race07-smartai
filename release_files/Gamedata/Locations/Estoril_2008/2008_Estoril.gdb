2008_Estoril
{
  ...
  TrackName = Estoril 08
  TrackNameShort = Estoril 08
  GrandPrixName = Estoril 08
  EventName = Round 11&12: Estoril 08
  EventDate= 11-13 July, Portugal
  VenueName = Estoril GP
  Location = Cascais, Portugal
  Length = 2.598 mi / 4.182 km
  Track Record = Nicola Larini 01:47.325
  TrackInfo=ESTORIL INFO
  Category=2008
...
Drafting
{
 ...
 // Locality
  ...
  NorthDir = 260 // in degrees (def. 245)
