2006_Curitiba
{
  ...
  TrackName = Curitiba, 2006 FIA WTCC Round 5
  TrackNameShort = Curitiba 06
  GrandPrixName = Curitiba, 2006
  EventName = Round 5: Curitiba
  VenueName = Race of Brazil
  Location = Curitiba, Brazil
  Length = 2.296 mi / 3.695 km
  Track Record = augusto farfus 01:24.761
  EventDate = 1-2 July, Brazil
  TrackInfo=CURITIBA INFO
  Category=2006

  SettingsFolder = Curitiba
  SettingsCopy = Curitiba.svm
  SettingsAI = Curitiba.svm
