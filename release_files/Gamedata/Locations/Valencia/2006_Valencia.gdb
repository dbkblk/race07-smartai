2006_Valencia
{
  ...
  TrackName = Valencia, 2006 FIA WTCC Round 9
  TrackNameShort = Valencia 06
  GrandPrixName = Valencia 2006
  EventName = WTCC Round 2: Valencia
  VenueName = Race of Spain
  Location = Valencia, Spain
  Length = 2.489 mi / 4.005 km
  Track Record = jordi gene 01:42.778
  EventDate = 7-8 October, Spain
