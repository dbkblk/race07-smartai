2007_Monza_2
{
  ...
  TrackName = Monza Junior
  TrackNameShort = Monza Junior
  GrandPrixName = Monza Junior
  EventName = Monza Junior
  VenueName = Race of Italy
  Location = Monza, Italy
  Length = 1.494 mi /2.405 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = 2006_Monza_2
  SettingsCopy = 2006_Monza_2.svm
  SettingsAI = 2006_Monza_2.svm
