...

{
  IGAID=211
  Category=VARIATIONS
  AI Vehicle Filter = Hockenheim_Short
  ...
  GameName = RR The Game
  TrackName = Hockenheim Short, 2010 FIA WTCC Round 14
  TrackNameShort = Hockenheim Short
  GrandPrixName = Hockenheim Short
  EventName = HOCKENHEIM SHORT	
  VenueName = Hockenheim Short
  Location =  Hockenheim_SH, Germany
  Length = 1.639 mi/2.638 km
  Track Record = Walter Lechner Jr, 1:00.500, #004 Saleen S7-R
  EventDate=
  TrackInfo=Circuit
  Category=Race

  SettingsFolder = Hockenheim_Short
  SettingsCopy = Hockenheim_Short.svm
  SettingsAI = Hockenheim_Short.svm
  Qualify Laptime = 58.000
  Race Laptime = 60.500
  Fast lap = 65
  Slow lap = 77
  Difficulty = 4
...
// Locality
  ...
  SunriseAmbientColour = (90,85,80)
//  SunriseDirectionalColour =  (223,236,255)
  SunriseDirectionalColour =  (350,300,250)
  ...
  DayAmbientColour =(121,128,135)
//  DayDirectionalColour = (255,240,215)
  DayDirectionalColour = (350,300,250)
  ...
  SunsetAmbientColour = (123,129,135)
//  SunsetDirectionalColour = (255,240,215)
  SunsetDirectionalColour = (350,300,250)
  ...
  NorthDir = 330 // in degrees (def. 245)
