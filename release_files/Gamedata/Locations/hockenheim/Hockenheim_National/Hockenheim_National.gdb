Hockenheim_National
{
  IGAID=524
  Category=VARIATIONS
  AI Vehicle Filter = Hockenheim_National
  ...
  TrackName = Hockenheim National
  TrackNameShort = Hockenheim Nat
  GrandPrixName = Hockenheim National
  EventName = HOCKENHEIM NATIONAL
  VenueName = Hockenheim National
  Location =  Hockenheim_NT, Germany
  Length = 2.294 mi/3.692 km
  Track Record = Walter Lechner Jr, 1:23.000, #004 Saleen S7-R
  EventDate=
  TrackInfo=Circuit
  Category=Race
  
  SettingsFolder = Hockenheim_National
  SettingsCopy = Hockenheim_National.svm
  SettingsAI = Hockenheim_National.svm
