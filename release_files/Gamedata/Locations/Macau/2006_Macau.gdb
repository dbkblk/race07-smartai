2006_Macau
{
  ...
  TrackName = Macau, 2006 FIA WTCC 10
  TrackNameShort = Macau 06
  GrandPrixName = Macau, 2006
  EventName = Round 10: Macau
  VenueName = Race of Macau
  Location = Macau
  Length = 3.801 mi / 6.117 km
  Track Record = andy priaulx 02:31.712
  EventDate = 17-19 November, Macau
  TrackInfo=MACAU INFO
  Category=2006

  SettingsFolder = 2006_Macau
  SettingsCopy = 2006_Macau.svm
  SettingsAI = 2006_Macau.svm
