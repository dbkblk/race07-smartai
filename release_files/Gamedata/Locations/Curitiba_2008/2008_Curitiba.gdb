2008_Curitiba
{
  ...
  TrackName = Curitiba, 2008 FIA WTCC Round 1&2
  TrackNameShort = Curitiba 08
  GrandPrixName = Curitiba, 2008
  EventName = Round 1&2: Curitiba 08
  VenueName = Race of Brazil
  Location = Curitiba, Brazil
  Length = 2.296 mi / 3.695 km
  Track Record = Rickard Rydell 01:24.295
  EventDate = 1-2 March, Brazil
