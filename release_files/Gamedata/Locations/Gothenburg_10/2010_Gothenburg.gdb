2010_Gothenburg
{
  ...
  TrackName = Gothenburg City Track 10
  TrackNameShort = Gothenburg 10
  GrandPrixName = Gothenburg City, 2010
  EventName = Round 5: Gothenburg City
  VenueName = Gothenburg STCC 2010
  Location = Gothenburg, Sweden
  Length = 1.025 mi/1.650 km
  Track Record = Thomas Schie 0:47.020
  EventDate=4 June, Sweden
  TrackInfo=
  Category=STCC'10

  SettingsFolder = 2010_Gothenburg
  SettingsCopy = Gothenburg.svm
  SettingsAI = Gothenburg.svm
