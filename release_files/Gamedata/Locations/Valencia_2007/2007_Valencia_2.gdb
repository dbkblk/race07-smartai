...
{
  IGAID=97
  AI Vehicle Filter = Valencia_2007
  ...
  TrackName = Valencia Nacional
  TrackNameShort = Valencia Nacional
  GrandPrixName = Valencia Nacional
  EventName = Valencia 
  VenueName = Race of Spain
  Location = Valencia, Spain
  Length = 1.926 mi / 3.099 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Valencia_2_2007
  SettingsCopy = Valencia_2_2007.svm
  SettingsAI = Valencia_2_2007.svm
