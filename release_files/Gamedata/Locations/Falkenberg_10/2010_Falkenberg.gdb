2010_Falkenberg
{
  ...
  TrackName = Falkenberg Motorbana 10
  TrackNameShort = Falkenberg 10
  GrandPrixName = Falkenberg, 2010
  EventName = Round 7: Falkenberg
  VenueName = Falkenberg STCC 2010
  Location = Falkenberg, Sweden
  Length = 1.145 mi/1.843 km
  Track Record = Robin Rudholm 0:44.978
  EventDate=9 July, Sweden
  TrackInfo=
  Category=STCC'10

  SettingsFolder = 2010_Falkenberg
  SettingsCopy = Falkenberg.svm
  SettingsAI = Falkenberg.svm
...
//  RainDayFogOutMultiply=(0.7, 0.85, 0.99)
  ...
  NorthDir = 120 // in degrees (def. 245)
