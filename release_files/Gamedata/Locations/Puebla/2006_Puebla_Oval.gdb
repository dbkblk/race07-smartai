2006_Puebla_Oval
{
  ...
  TrackName = Puebla Oval
  TrackNameShort = Puebla Oval
  GrandPrixName = Puebla, 2006
  EventName = Puebla Oval
  VenueName = Race of Mexico
  Location = Puebla, Mexico
  Length = 1.349 mi / 2.171 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Puebla_Oval
  SettingsCopy = Puebla_Oval.svm
  SettingsAI = Puebla_Oval.svm
