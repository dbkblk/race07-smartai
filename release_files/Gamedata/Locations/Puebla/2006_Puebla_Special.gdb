...
{
  IGAID=89
  AI Vehicle Filter = Puebla_Special
  ...
  TrackName = Puebla Special
  TrackNameShort = Puebla Special
  GrandPrixName = Puebla Special
  EventName = Puebla
  ...
  EventDate=
  TrackInfo=PUEBLA SPECIAL INFO
  Category=VARIATIONS

  SettingsFolder = Puebla_Special
  SettingsCopy = Puebla_Special.svm
  SettingsAI = Puebla_Special.svm
