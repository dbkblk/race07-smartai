2007_Oschersleben_2
{
  ...
  TrackName = Oschersleben B-Course
  TrackNameShort = Oschersleben B-Course 07
  GrandPrixName = Oschersleben B-Course
  EventName = Oschersleben
  VenueName = Race of Germany
  Location = Oschersleben, Germany
  Length = 1.616 mi / 2.600 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Oschersleben_2
  SettingsCopy = Oschersleben_2.svm
  SettingsAI = Oschersleben_2.svm
  Qualify Laptime = 68.000
  Race Laptime = 69.000
