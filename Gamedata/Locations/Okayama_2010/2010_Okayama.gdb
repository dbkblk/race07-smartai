2010_Okayama
{
  AI Vehicle Filter = 2010_Okayama
	IGAId=530
  ...
  TrackName = Okayama 10
  TrackNameShort = Okayama 10
  GrandPrixName = Okayama, 2010
  EventName = Round 19&20: Okayama 10
  VenueName = Race of Japan
  Location = Okayama, Japan
  Length = 2.300 mi/3.703 km
  Track Record = Augusto Farfus 1:37.040
  EventDate=30-31 October, Japan
  TrackInfo=
  Category=2010

  SettingsFolder = Okayama
  SettingsCopy = Okayama.svm
  SettingsAI = Okayama.svm
