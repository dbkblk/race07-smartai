Gothenburg
{
  ...
  TrackName = Gothenburg City Track
  TrackNameShort = Gothenburg
  GrandPrixName = Gothenburg City, 2008
  EventName = Round 5: Gothenburg City
  VenueName = Gothenburg STCC 2008
  Location = Gothenburg, Sweden
  Length = 1.025 mi/1.650 km
  Track Record = Thomas Schie 0:47.020
  EventDate=14 June, Sweden
  TrackInfo=
  Category=STCC

  SettingsFolder = Gothenburg
