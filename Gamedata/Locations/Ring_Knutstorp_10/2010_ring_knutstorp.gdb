...
{
  IGAID=303
  AI Vehicle Filter = ring_knutstorp
  ...
  TrackName = Ring Knutstorp Motorbana 10
  TrackNameShort = Knutstorp 10
  GrandPrixName = Ring Knutstorp, 2010
  EventName = Round 1&9: Knutstorp
  VenueName = Knutstorp STCC 2010
  Location = Knutstorp, Sweden
  Length = 1.286 mi/2.070 km
  Track Record = Fredrik Ekblom 1:00.571
  EventDate=7 May, Sweden
  TrackInfo=
  Category=STCC'10

  SettingsFolder = 2010_Ring_Knutstorp
  SettingsCopy = Ring_Knutstorp.svm
  SettingsAI = Ring_Knutstorp.svm
