CrownePlazaRaceway
{
  IGAID=200
  Category=VARIATIONS
  AI Vehicle Filter = CrownePlazaRaceway
  ...
  TrackName = Crowne Plaza Raceway
  TrackNameShort = Crowne Plaza Raceway
  GrandPrixName = Crowne Plaza Raceway 2008
  EventName = Crowne Plaza Raceway
  VenueName = Crowne Plaza Raceway
  Location = Florianopolis, Crowne Island
  Length = 3.331 mi / 5.361 km
  Track Record = Andy Priaulx 1:51.427
  EventDate =
  TrackInfo=CROWNE_INFO
  Category=Other

  SettingsFolder = CrownePlazaRaceway
  SettingsCopy = CrownePlazaRaceway.svm
  SettingsAI = CrownePlazaRaceway.svm
