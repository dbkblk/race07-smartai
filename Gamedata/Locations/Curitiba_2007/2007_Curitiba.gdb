2007_Curitiba
{
  ...
  TrackName = Curitiba, 2007 FIA WTCC Round 1&2
  TrackNameShort = Curitiba 07
  GrandPrixName = Curitiba, 2007
  EventName = Round 1&2: Curitiba 07
  VenueName = Race of Brazil
  Location = Curitiba, Brazil
  Length = 2.296 mi / 3.695 km
  Track Record = augusto farfus 01:24.761
  EventDate = 10-11 March, Brazil
