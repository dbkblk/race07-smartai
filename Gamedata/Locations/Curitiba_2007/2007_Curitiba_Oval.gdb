...
{
  IGAID=34
  AI Vehicle Filter = 2007_Curitiba_Oval
  ...
  TrackName = Curitiba Oval
  TrackNameShort = Curitiba Oval
  GrandPrixName = Curitiba Oval
  EventName = Curitiba Oval
  VenueName = Race of Brazil
  Location = Curitiba, Brazil
  Length = 1.585 mi / 2.550 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = 2007_Curitiba_Oval
  SettingsCopy = 2007_Curitiba_Oval.svm
  SettingsAI = 2007_Curitiba_Oval.svm
