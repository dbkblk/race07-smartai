...
{{
  IGAID=520
  Category=STCC'10
  AI Vehicle Filter = Jyllandsringen_GP
  ...
  TrackName = FDM Jyllandsringen
  TrackNameShort = FDM Jyllandsringen
  GrandPrixName = FDM Jyllandsringen, 2010
  EventName = Round 135: Jyllandsringen GP
  VenueName = FDM Jyllandsringen, 2010
  Location = Silkeborg, Denmark
  EventDate= 25 April, Denmark
  Length = 1.410 m./2.270 km.
  Track Record = 
