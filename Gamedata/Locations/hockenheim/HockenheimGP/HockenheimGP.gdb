HockenheimGP
{
  IGAID=210
  Category=VARIATIONS
  AI Vehicle Filter = HockenheimGP
  ...
  TrackName = Hockenheim GP, 2010 FIA WTCC Round 4
  TrackNameShort = Hockenheim GP
  GrandPrixName = Hockenheim GP2010
  EventName = Round 4: HOCKENHEIM GP
  VenueName = Hockenheim GP, 2010
  Location =  Hockenheim, Germany
  Length = 2.842 mi/4.574 km
  Track Record = Walter Lechner Jr, 1:37.132, #004 Saleen S7-R
  EventDate=
  TrackInfo=Circuit
  Category=Race
  
  SettingsFolder = HockenheimGP
  SettingsCopy = HockenheimGP.svm
  SettingsAI = HockenheimGP.svm
