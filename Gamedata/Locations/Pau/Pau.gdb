Pau
{
  ...
  TrackName = Pau, 2007 FIA WTCC Round 7&8
  TrackNameShort = Pau 07
  GrandPrixName = Pau, 2007
  EventName = WTCC Round 7&8: Pau
  VenueName = Race of France
  Location = Pau, France
  Length = 1.715 mi / 2.760 km
  Track Record = alain menu 1:21.930
  EventDate = 2-3 June, France
  TrackInfo=PAU INFO
  Category=2007

  SettingsFolder = Pau
  SettingsCopy = Pau.svm
  SettingsAI = Pau.svm
