Hill
{
  IGAID=333
  Category=VARIATIONS
  AI Vehicle Filter = Hill
  TestDayDay = Wednesday
  TestDayStart = 16:00
  Practice1Day = Friday
  Practice1Start = 16:00
  Practice2Day = Friday
  ...
  TrackName = RaceRoom Hillclimb
  TrackNameShort = RaceRoom Hillclimb
  GrandPrixName = Hill
  EventName = Hillclimb
  VenueName = Hill
  Location =  The Alps, Austria
  Length = 3.816 mi/6.142 km
  Track Record = 
  EventDate=
  TrackInfo=Circuit
  ...
  SettingsFolder = Hill
  SettingsCopy = Hill.svm
  SettingsAI = Hill.svm
  Qualify Laptime = 182.000
  Race Laptime = 182.000
...
//  RainDayFogOutMultiply=(0.7, 0.85, 0.99)
  ...
  NorthDir = 130 // in degrees (def. 245)
