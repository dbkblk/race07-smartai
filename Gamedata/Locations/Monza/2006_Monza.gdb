2006_Monza
{
  ...
  TrackName = Monza, 2006 FIA WTCC Round 1
  TrackNameShort = Monza 06
  GrandPrixName = Monza, 2006
  EventName = Round 1: Monza
  VenueName = Race of Italy
  Location = Monza, Italy
  Length = 3.600 mi /5.793 km
  Track Record = andy priaulx 02:00.254
  EventDate = 1-2 April, Italy
  TrackInfo=MONZA INFO
  Category=2006

  SettingsFolder = 2006_Monza
  SettingsCopy = 2006_Monza.svm
  SettingsAI = 2006_Monza.svm
...
Drafting
{
  ...
  NorthDir = 230 // in degrees (def. 245)
