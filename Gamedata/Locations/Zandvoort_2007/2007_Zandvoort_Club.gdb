...
{
  IGAID=181
  AI Vehicle Filter = 2007_Zandvoort_Club
  ...
  TrackName = Zandvoort Club
  TrackNameShort = Zandvoort Club
  GrandPrixName = Zandvoort Club, 2007
  EventName = Zandvoort Club
  VenueName = Race of Netherlands
  Location = Zandvoort, Netherlands
  Length = 1.562 mi / 2.514 km
  Track Record=
  EventDate=
  TrackInfo=
  Category=VARIATIONS
