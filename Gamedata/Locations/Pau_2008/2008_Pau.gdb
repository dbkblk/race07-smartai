2008_Pau
{
  ...
  TrackName = Pau, 2008 FIA WTCC Round 7&8
  TrackNameShort = Pau 08
  GrandPrixName = Pau, 2008
  EventName = Round 7&8: Pau 08
  VenueName = Race of France
  Location = Pau, France
  Length = 1.715 mi / 2.760 km
  Track Record = Alain Menu 1:21.930
  EventDate = 1 June, France
  TrackInfo=PAU INFO
  Category=2008
