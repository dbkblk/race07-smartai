...
{
  IGAID=538
  AI Vehicle Filter = Valencia_2010
  ...
  TrackName = Valencia 10, 2010 FIA WTCC Round 17&18
  TrackNameShort = Valencia 10
  GrandPrixName = Valencia, 2010
  EventName = Round 17&18: Valencia 10
  VenueName = Race of Spain
  Location = Valencia 10, Spain
  Length = 2.489 mi / 4.005 km
  Track Record = augusto farfus 1:40.819
  EventDate = 18-19 September, Spain
