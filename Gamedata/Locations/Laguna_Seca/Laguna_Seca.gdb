Laguna_Seca
{
  ...
  TrackNameShort = Laguna Seca
  GrandPrixName = Laguna Seca, 2008
  EventName = Round 13&14: Laguna Seca
  VenueName = Race of USA
  Location = Laguna Seca, USA
  Length = 2.238 mi/3.601 km
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Laguna_Seca
  SettingsCopy = Laguna_Seca.svm
  SettingsAI = Laguna_Seca.svm
