Valerbanen
{
  ...
  TrackName = Valer banen
  TrackNameShort = Valer
  GrandPrixName = Valer banen, 2008
  EventName = Round 10: Valer banen
  VenueName = Valer STCC 2008
  Location = Valerbanen, Norway
  Length = 1.405 mi/2.262 km
  Track Record = STCC 0:57.052
  EventDate=14 September, Norway
  TrackInfo=
  Category=STCC

  SettingsFolder = Valerbanen
  SettingsCopy = Valerbanen.svm
  SettingsAI = Valerbanen.svm
