2006_Oschersleben
{
  ...
  TrackName = Oschersleben, 2006 FIA WTCC Round 4
  TrackNameShort = Oschersleben 06
  GrandPrixName = Oschersleben, 2006
  EventName = Round 8: Oschersleben
  VenueName = Race of Germany
  Location = Oschersleben, Germany
  Length = 2.279 mi / 3.667 km
  Track Record = andy priaulx 01:35.661
  EventDate = 3-4 June, Germany
  TrackInfo=OSCHERSLEBEN INFO 06
  Category=2006
