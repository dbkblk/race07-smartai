2007_Valencia
{
  ...
  TrackName = Valencia 07, 2006 FIA WTCC Round 5&6
  TrackNameShort = Valencia 07
  GrandPrixName = Valencia, 2007
  EventName = Round 5&6: Valencia 
  VenueName = Race of Spain
  Location = Valencia 07, Spain
  Length = 2.489 mi / 4.005 km
  Track Record = augusto farfus 1:40.819
  EventDate = 19-20 May, Spain
