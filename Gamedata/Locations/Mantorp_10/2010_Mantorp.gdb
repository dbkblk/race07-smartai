2010_Mantorp
{
  ...
  TrackName = Mantorp Park Motorbana 10
  TrackNameShort = Mantorp 10
  GrandPrixName = Mantorp Park, 2010
  EventName = Round 3&11: Mantorp Park
  VenueName = Mantorp STCC 2010
  Location = Mantorp, Sweden
  Length = 1.929 mi/3.106 km
  Track Record = STCC 1:21.203
  EventDate=1 October, Sweden
  TrackInfo=
  Category=STCC'10

  SettingsFolder = 2010_Mantorp
  SettingsCopy = Mantorp.svm
  SettingsAI = Mantorp.svm
