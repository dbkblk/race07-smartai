...
{
  IGAID=43
  AI Vehicle Filter = 2007_Macau_REV
  ...
  TrackName = Macau Reverse
  TrackNameShort = Macau Reverse
  GrandPrixName = Macau Reverse
  EventName = Macau Reverse
  ...
  SettingsFolder = 2007_Macau_REV
  SettingsCopy = 2007_Macau_REV.svm
  SettingsAI = 2007_Macau_REV.svm
  Qualify Laptime = 149.000
  Race Laptime = 151.000
