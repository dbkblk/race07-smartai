2007_Vara
{
  ...
  TrackName = Vara Raceway, 2007
  TrackNameShort = Vara Raceway
  GrandPrixName = Vara Raceway
  EventName = Vara Raceway
  EventDate=
  VenueName = Race of Vara
  Location = Vara, Sweden
  Length = 2.569 mi / 4.135 km
  Track Record=
  TrackInfo=VARA RACEWAY INFO
  Category=VARIATIONS

  SettingsFolder = 2007_Vara
  SettingsCopy = 2007_Vara.svm
  SettingsAI = 2007_Vara.svm
...
// Locality
  ...
  NorthDir = 70 // in degrees (def. 245)
