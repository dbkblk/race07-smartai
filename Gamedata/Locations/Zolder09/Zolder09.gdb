Zolder09
{
  ...
  TrackName = Zolder 10, 2010 FIA WTCC Round 7&8
  TrackNameShort = Zolder 10
  GrandPrixName = Zolder, 2010 10
  EventName = Round 7&8: Zolder 10
  VenueName = Race of Belgium
  Location = Zolder, Belgium
  Length = 2.49 mi/4.012 km
  Track Record = Augusto Farfus 1:37.040
  EventDate=19-20 June, Belgium
  TrackInfo=Circuit
  Category=2010

  SettingsFolder = Zolder09
  SettingsCopy = Zolder09.svm
  SettingsAI = Zolder09.svm
