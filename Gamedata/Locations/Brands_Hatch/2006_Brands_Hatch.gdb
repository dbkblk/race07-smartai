...
{
  IGAId=10
  AI Vehicle Filter = Brands_Hatch
  ...
  TrackName = Brands Hatch, FIA WTCC Round 4
  TrackNameShort = Brands Hatch 06
  GrandPrixName = Brands Hatch, 2006
  EventName = Round 4: Brands Hatch
  VenueName = Race of United Kingdom
  Location = Kent, United Kingdom
  Length = 2.304 mi / 3.708 km
  Track Record = rickard rydell 01:34.493
  EventDate=20-21 May, United Kingdom
