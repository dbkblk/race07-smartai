Mantorp
{
  ...
  TrackName = Mantorp Park Motorbana
  TrackNameShort = Mantorp
  GrandPrixName = Mantorp Park, 2008
  EventName = Round 3&11: Mantorp Park
  VenueName = Mantorp STCC 2008
  Location = Mantorp, Sweden
  Length = 1.929 mi/3.106 km
  Track Record = STCC 1:21.203
  EventDate=28 September, Sweden
  TrackInfo=
  Category=STCC

  SettingsFolder = Mantorp
