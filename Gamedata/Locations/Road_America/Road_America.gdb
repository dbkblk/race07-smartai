...
{
  IGAID=451
  AI Vehicle Filter = Road_America
  ...
  TrackNameShort = Road America
  GrandPrixName = Road America, 2008
  EventName = Round 13&14: Road America
  VenueName = Race of USA
  Location = Road America, USA
  Length = 4.048 mi/6.515 km
  EventDate=
  TrackInfo=
  Category=VARIATIONS

  SettingsFolder = Road_America
  SettingsCopy = Road_America.svm
  SettingsAI = Road_America.svm
...
// Locality
  ...
  NorthDir = 300 // in degrees (def. 245)
